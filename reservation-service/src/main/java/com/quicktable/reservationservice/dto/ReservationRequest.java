...
public class ReservationRequest {
    ...
    // Предпочитана локация: INSIDE, SUMMER_GARDEN, WINTER_GARDEN (optional)
    private TableLocation preferredLocation; // Optional - ако е null, системата избира произволна локация
